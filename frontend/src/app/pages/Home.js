...
const Home = () => {
    ...
    return (
        <div className='flex flex-col p-10 gap-4'>
            ...
            {/* <LineChart /> */}
            <button className='btn btn-outline' onClick={mint}>Mint NFT</button>
            <button className='btn btn-outline' onClick={getTotalSupply}>get total supply</button>
            {/* <Stats />
            <CommunityMembers /> */}

            <div className='flex flex-row justify-between'>
                <div className='flex flex-col justify-between'>
                    <img className='w-32' src={nftImg} />
                            ...
                            <ul>
                                <li className='flex flex-row justify-between items-center'>
                                    ...
                                    <svg width={60} height={15}>
                                        <rect width={10} height={10} x={0} y={0} style={{ fill: '#ff0000' }} />
                                        <rect width={10} height={10} x={12} y={0} style={{ fill: '#ff0000' }} />
                                        <rect width={10} height={10} x={24} y={0} style={{ fill: '#ff0000' }} />
                                        <rect width={10} height={10} x={36} y={0} style={{ fill: '#ff0000' }} />
                                        <rect width={10} height={10} x={48} y={0} style={{ fill: '#ff0000' }} />
                                    </svg>
                                </li>
                                <li className='flex flex-row justify-between items-center'>
                                    <span>Quality</span>
            ...
            <div className="stats shadow-lg border mt-10">
